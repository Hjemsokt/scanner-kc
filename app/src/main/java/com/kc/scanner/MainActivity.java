...
import com.kc.scanner.utils.CheckPermissionUtils;
...
public class MainActivity extends BaseActivity implements EasyPermissions.PermissionCallbacks{
     ...
     *  相机扫描 入库
     */
    public static final int IN_CAM = 101;

    /**
     *  相机扫描 出库
     */

    public static final int OUT_CAM = 102;


    /**
     * 系统图片扫描入库
     */
    public static final int IN_IMA = 201;

    /**
     * 系统图片扫描出库
     */
    public static final int OUT_IMA = 202;
    ...
    protected void onCreate(Bundle savedInstanceState) {
		...
		handler = new Handler() {
			...
			public void handleMessage(Message msg) {
				...
				if (msg.what == 0x123) {
					// 将读取的内容追加显示在文本框中
					Toast.makeText(getApplicationContext(), "解析结果:" + msg
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        */
        ...
        if (IN_CAM == requestCode || OUT_CAM == requestCode) {
            //处理扫描结果（在界面上显示）
            if (null != data) {
                ...
                if (bundle.getInt(CodeUtils.RESULT_TYPE) == CodeUtils.RESULT_SUCCESS) {
					...
					msg.what = IN_CAM == requestCode ? 0x345 : 0x456;
					msg.obj = result;
    ...
    class ButtonOnClickListener implements View.OnClickListener{
        ...
        public void onClick(View v) {
            if (v.getId() == R.id.button3 || v.getId() == R.id.button4) {
                ...
                startActivityForResult(intent, v.getId() == R.id.button3 ? IN_IMA : OUT_IMA);
    ...
    private void onClick(int buttonId) {
        switch (buttonId) {
            case R.id.button1:
                ...
                startActivityForResult(intent, IN_CAM);
                break;
            case R.id.button2:
                intent = new Intent(MainActivity.this, SecondActivity.class);
                startActivityForResult(intent, OUT_CAM);
                break;
            default:
                break;
        }
